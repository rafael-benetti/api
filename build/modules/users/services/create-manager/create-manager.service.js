...
let CreateManagerService = class CreateManagerService {
    constructor(usersRepository, mailProvider, hashProvider, logsRepository, ormProvider) {
    ...
    async execute({ userId, email, name, groupIds, permissions, phoneNumber, }) {
        ...
        this.logsRepository.create({
            ...
            groupId: undefined,
            ownerId: user.ownerId || user.id,
            type: log_type_enum_1.default.CREATE_MANAGER,
            userId: manager.id,
        });
...
CreateManagerService = __decorate([
