...
let ListManagersService = class ListManagersService {
    ...
    async execute({ userId, groupId, limit, offset }) {
        ...
        if (user.role !== role_1.default.OWNER && !user.permissions?.listManagers)
...
ListManagersService = __decorate([
    tsyringe_1.injectable(),
    __param(0, tsyringe_1.inject('UsersRepository')),
    __metadata("design:paramtypes", [Object])
], ListManagersService);
exports.default = ListManagersService;
