...
let ListOperatorsService = class ListOperatorsService {
    ...
    async execute({ userId, groupId, limit, offset }) {
        ...
        if (user.role !== role_1.default.OWNER && !user.permissions?.listOperators)
...
ListOperatorsService = __decorate([
    tsyringe_1.injectable(),
    __param(0, tsyringe_1.inject('UsersRepository')),
    __metadata("design:paramtypes", [Object])
], ListOperatorsService);
exports.default = ListOperatorsService;
