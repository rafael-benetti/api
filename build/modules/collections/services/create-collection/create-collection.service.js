...
let CreateCollectionService = class CreateCollectionService {
    constructor(usersRepository, machinesRepository, routesRepository, storageProvider, telemetryLogsRepository, pointsOfSaleRepository, collectionsRepository, logsRepository, ormProvider) {
    ...
    async execute({ userId, machineId, observations, boxCollections, files, startTime, endLocation, startLocation, }) {
        ...
        this.logsRepository.create({
            ...
            type: log_type_enum_1.default.CREATE_COLLECTION,
...
CreateCollectionService = __decorate([
    ...
    __param(7, tsyringe_1.inject('LogsRepository')),
    __param(8, tsyringe_1.inject('OrmProvider')),
