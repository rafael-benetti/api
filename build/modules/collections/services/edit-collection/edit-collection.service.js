...
let EditCollectionService = class EditCollectionService {
    constructor(collectionsRepository, usersRepository, telemetryLogsRepository, machinesRepository, pointsOfSaleRepository, ormProvider, logsRepository, groupsRepository, storageProvider) {
    ...
    async execute({ userId, collectionId, machineId, files, photosToDelete, boxCollections, observations, }) {
        ...
        this.logsRepository.create({
            ...
            type: log_type_enum_1.default.EDIT_COLLECTION,
...
EditCollectionService = __decorate([
    ...
    __param(6, tsyringe_1.inject('LogsRepository')),
    __param(7, tsyringe_1.inject('GroupsRepository')),
    __param(8, tsyringe_1.inject('StorageProvider')),
