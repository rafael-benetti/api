...
let CreateMachineService = class CreateMachineService {
    constructor(machinesRepository, usersRepository, ormProvider, categoriesRepository, pointsOfSaleRepository, counterTypesRepository, groupsRepository, telemetryBoardsRepository, logsRepository) {
    ...
    async execute({ userId, categoryId, boxes, gameValue, groupId, locationId, operatorId, serialNumber, telemetryBoardId, typeOfPrizeId, minimumPrizeCount, incomePerMonthGoal, incomePerPrizeGoal, }) {
        ...
        this.logsRepository.create({
            ...
            type: log_type_enum_1.default.CREATE_MACHINE,
...
CreateMachineService = __decorate([
    ...
    __param(8, tsyringe_1.inject('LogsRepository')),
