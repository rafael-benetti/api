...
let RemoteCreditService = class RemoteCreditService {
    constructor(usersRepository, machinesRepository, machineLogsRepository, mqttProvider, logsRepository, ormProvider) {
    ...
    async execute({ userId, machineId, observations, quantity, }) {
        ...
        this.logsRepository.create({
            ...
            type: log_type_enum_1.default.REMOTE_CREDIT,
            machineId: machine.id,
            quantity: Number(quantity),
        });
