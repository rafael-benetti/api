...
const remote_credit_controller_1 = __importDefault(require("../services/remote-credit/remote-credit.controller"));
...
machineLogsRouter.post('/:machineId', remote_credit_controller_1.default.handle);
