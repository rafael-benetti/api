...
const get_machine_income_per_day_1 = __importDefault(require("../dtos/get-machine-income-per-day"));
const get_point_of_sale_income_per_date_dto_1 = __importDefault(require("../dtos/get-point-of-sale-income-per-date.dto"));
const get_prizes_per_machine_repository_dto_1 = __importDefault(require("../dtos/get-prizes-per-machine-repository.dto"));
const telemetry_log_1 = __importDefault(require("../entities/telemetry-log"));
