...
let CreateNotificationService = class CreateNotificationService {
    constructor(ormProvider, notificationProvider, notificationsRepository) {
        this.ormProvider = ormProvider;
        this.notificationProvider = notificationProvider;
        this.notificationsRepository = notificationsRepository;
    }
    async execute({ body, title, topic, type }) {
...
CreateNotificationService = __decorate([
    ...
    __param(2, tsyringe_1.inject('NotificationsRepository')),
