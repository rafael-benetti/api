...
let CreateCounterTypeService = class CreateCounterTypeService {
    ...
    async execute({ userId, label, type }) {
...
CreateCounterTypeService = __decorate([
...
exports.default = CreateCounterTypeService;
