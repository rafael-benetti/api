...
let GiftsScript = class GiftsScript {
    constructor(typeGiftsRepository, telemetryLogsRepository, typeMachinesRepository, machinesRepository, ormProvider) {
    ...
    async execute() {
        ...
        try {
            for (const gift of gifts) {
                ...
                const machineId = (await this.client.get(`@machines:${gift.machineId}`));
...
GiftsScript = __decorate([
    ...
    __metadata("design:paramtypes", [type_gifts_respository_1.default, Object, type_machines_repository_1.default, Object, Object])
], GiftsScript);
